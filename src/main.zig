...
pub fn main() !void {
    ...
    try make_moons(.{
        .epochs = 50,
        .load_checkpoint = "./weights/make_moons_weights.txt",
        .save_checkpoint = "./weights/make_moons_weights.txt",
        .train = true,
        .layer_spec = .{
            .shape = shape[0..],
            .nonlin = nonlin[0..],
    ...
    // try mnist(.{
    //     .epochs = 1,
    //     .load_checkpoint = "./weights/mnist_weights.txt",
    //     .save_checkpoint = "./weights/mnist_weights.txt",
    //     .train = false,
    //     .layer_spec = .{
    //         .shape = shape[0..],
    //         .nonlin = nonlin[0..],
